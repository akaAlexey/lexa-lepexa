...
def upgrade():
    ...
    op.create_table("graves",sa.Column("id",S(50),primary_key=True),sa.Column("lat",sa.Float),sa.Column("lon",sa.Float),sa.Column("full_name",S(255)),sa.Column("unit",S(255)),sa.Column("demo",sa.Boolean),)
    op.create_table("battles",sa.Column("id",S(50),primary_key=True),sa.Column("date",sa.Date),sa.Column("text",sa.Text),sa.Column("archive_url",sa.Text),sa.Column("place_name",S(255)),sa.Column("lat",sa.Float),sa.Column("lon",sa.Float),sa.Column("demo",sa.Boolean),)
