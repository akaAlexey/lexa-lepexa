 ...
 * «Новости недели», платёж в процессе оплаты) и «Мои живые фото» (сами снимки — больше лимита
 * сервера на значение) остаются на устройстве.
 */
const EXACT = new Set([
  ...
  'role', // роль на сайте
  'wallet.tokens', // кошелёк условных токенов для учебной оплаты
])
