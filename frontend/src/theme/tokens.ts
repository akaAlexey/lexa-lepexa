 ...
 * Палитра — «Универсальный вариант», форма и карта — дизайн «Стол и газета» (ADR 0011).
...
export const tokens = {
  color: {
    ...
    /** Стиль карты — военная картография: оливковый, хаки, сепия + яркие акценты для детей (ADR 0011). */
    map: {
      land: '#DCD2AB',
      residential: '#D2C69C',
      field: '#D0C396',
  ...
  fontSizeBase: '112.5%',
  /** Газетная вёрстка: почти прямые углы, панели вместо «пузырей» (ADR 0011). */
  radius: {
