...
> **Статус: каркас.** Зафиксирована архитектура, работают навигация по ролям, тема, API-слой (mock/live), карта и тестовая инфраструктура. Полные сценарии трёх user story — следующий этап. Итоговая документация по всем осям появится к упаковке (требования — в [docs/HANDOFF.md](docs/HANDOFF.md)).
